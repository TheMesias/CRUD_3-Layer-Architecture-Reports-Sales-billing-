    ...
    public partial class Form1 : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            if (Editar == false)
            {
                try
                {
                    objetoCN.InsertarPRod(txt_nombre.Text, txt_descripcion.Text, txt_marca.Text, txt_precio.Text, txt_stock.Text);
            ...
            if (Editar == true) {
                try {
                    objetoCN.EditarProd(txt_nombre.Text,txt_descripcion.Text,txt_marca.Text,txt_precio.Text,txt_stock.Text,idProducto);
                    MessageBox.Show("Se guardo correctamente");
                    MostrarProductos();
                    Limpiar();
                    Editar = false;
        ...
        private void btn_venta_Click(object sender, EventArgs e)
        {
            if (venta == true)
            {
                try
                {
                    ...
                    if (entrega >= 0)
                    {
                        objetoCN.EditarProd(txt_nombre.Text, txt_descripcion.Text, txt_marca.Text, txt_precio.Text, entrega.ToString(), idProducto);
